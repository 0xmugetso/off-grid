...
export function sessionView(session: StoredPaymentSession, users: StoredUser[], currentUserId: string): PaymentSessionView {
  ...
  return {
    ...
    fiatSettlement: session.fiatSettlement ? {
      ...
      circleDepositAddressId: session.fiatSettlement.circleDepositAddressId ?? null,
      circleDepositAddress: session.fiatSettlement.circleDepositAddress ?? null,
      payerTransferTxHash: session.fiatSettlement.payerTransferTxHash ?? null,
      payerTransferBlockNumber: session.fiatSettlement.payerTransferBlockNumber ?? null,
      circleInboundTransferId: session.fiatSettlement.circleInboundTransferId ?? null,
      circleInboundTransferStatus: session.fiatSettlement.circleInboundTransferStatus ?? null,
      circlePayoutId: session.fiatSettlement.circlePayoutId ?? null,
      circlePayoutStatus: session.fiatSettlement.circlePayoutStatus ?? null,
      circlePayoutTrackingRef: session.fiatSettlement.circlePayoutTrackingRef ?? null,
      circlePayoutDestinationName: session.fiatSettlement.circlePayoutDestinationName ?? null,
